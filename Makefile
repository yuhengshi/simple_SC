...
server_c_udp: <"your_server_c_udp_program"> 
	$(CC) $(ARGS) -o server_c_udp <"your_server_c_udp_program">

client_c_udp: <"your_client_c_udp_program">
	$(CC) $(ARGS) -o client_c_udp <"your_client_c_udp_program">

server_c_tcp: <"your_server_c_tcp_program">
	$(CC) $(ARGS) -o server_c_tcp <"your_server_c_tcp_program">

client_c_tcp: <"your_client_c_tcp_program">
	$(CC) $(ARGS) -o client_c_tcp <"your_client_c_tcp_program">
